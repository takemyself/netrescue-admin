...
vjs.getAttributeValues = function(tag){
  ...
  // won't know abouts HTML5 boolean attributes that we still read from
 ...
 * abouts the source file. Use this method if you want the player to determine if
...
vjs.Flash = vjs.MediaTechController.extend({
  ...
  init: function(player, options, ready){
    ...
    // - Firefox just abouts always. https://bugzilla.mozilla.org/show_bug.cgi?id=90268 (might be fixed by version 13)
